...
function toggleAllNavSections(nav, expanded = 'false') {
  nav.querySelectorAll('.nav-sections .default-content-wrapper > ul > li').forEach((section) => {
 ...
 * @param {String} [forceExpanded] Optional param to force nav expand behavior when not null
 */
