import { h3, p } from '../../scripts/dom-helpers.js';
...
export default async function decorate(block) {
  ...
  block.classList.add(`tiles-${rows[0].children.length}-cols`);
  ...
  pages.forEach((page, idx) => {
    ...
    if (Object.hasOwn(lookupTable, pagePath)) {
      ...
      // Whenever Tiles refers to an external link, we get the details directly from the doc/author
