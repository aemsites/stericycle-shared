...
function getMetadata(name, doc = document) {
  ...
  if (meta && meta.startsWith('/forms')) {
    return window.location.origin.includes('shredit.com') ? meta : `https://main--shredit--stericycle.aem.live${meta}`;
  }
  return meta || '';
}
...
async function fetchPlaceholders(prefix = 'default') {
  ...
  if (!window.placeholders[prefix]) {
    window.placeholders[prefix] = new Promise((resolve) => {
      const formsPrefix = window.location.origin.includes('shredit.com') ? prefix : `https://main--shredit--stericycle.aem.live${prefix}`;
      const updatedPrefix = prefix.includes('forms') ? formsPrefix : prefix;
