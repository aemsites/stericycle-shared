...
export function getEnvironment() {
  ...
  if (hostname === 'localhost' || hostname.endsWith('.aem.page') || hostname.endsWith('.aem.live') || (hostname.startsWith('stage') && hostname.endsWith('.shredit.com')) || (hostname.startsWith('dev') && hostname.endsWith('.shredit.com'))) {
    return 'dev';
  }
